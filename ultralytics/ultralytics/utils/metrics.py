...
def Cos_A(x1,y1,x2,y2,x3,y3):
    a_b = torch.sqrt((x2 - x1) ** 2 + (y2 - y1) ** 2)
    a_c = torch.sqrt((x3 - x1) ** 2 + (y3 - y1) ** 2)
    b_c = torch.sqrt((x3 - x2) ** 2 + (y3 - y2) ** 2)
    CosA = (a_c ** 2 + a_b ** 2 - b_c ** 2)/ (2 * a_c * a_b)
    return CosA
...
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SIoU=False, EIoU=False, WIoU=False, Focal=False,Hiou=False,
    ...
    if Focal:
        ...
        CosA_1 = Cos_A(b1_x1, b1_y1, b2_x1, b2_y2, b2_x2, b2_y1)
        CosA_2 = Cos_A(b2_x2, b2_y2, b1_x1, b1_y2, b1_x2, b1_y1)
        CosA_3 = Cos_A(b1_x2, b1_y1, b2_x1, b2_y1, b1_x2, b2_y2)
        CosA_4 = Cos_A(b2_x1, b2_y2, b1_x1, b1_y1, b1_x2, b1_y2)
        cosA_11 = torch.maximum(CosA_1, CosA_2)
        cosA_22 = torch.maximum(CosA_3, CosA_4)
        cosA = torch.maximum(cosA_11, cosA_22)
        cosA = cosA * cosA
        # IoU
        iou = inter / union
        return iou - cosA
